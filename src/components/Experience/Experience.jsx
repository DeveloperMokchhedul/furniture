...
function Experience() {
  ...
  return (
    <>
      <div className=' mx-auto grid grid-cols-12 px-5 gap-10 items-center '>
        <div className='col-span-12 md:col-span-6 py-20'>
          <img ref={imageRef} src="/images/experienceBanner.png" alt="" />
        </div>
        <div ref={textRef} className='animationDiv col-span-12 md:col-span-6 flex flex-col gap-y-4 '>
          <h3 className='text-red-600 font-poppin md:tracking-[12px] text-md md:text-xl text-center md:text-start ' >EXPERIENCES</h3>
          <h1 className='text-[22px] text-center md:text-start md:text-[50px] font-bold  md:leading-[60px]'>We Provide you the Best Experience</h1>
